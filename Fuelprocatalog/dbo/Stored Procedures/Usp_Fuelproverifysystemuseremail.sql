CREATE PROCEDURE [dbo].[Usp_Fuelproverifysystemuseremail]
	...
	DECLARE 
		...
		BEGIN TRANSACTION;
	 	 SET @StaffDetails = (
			...
			a.Loginstatus,a.Passwordresetdate,a.Createdby,a.Modifiedby,a.Lastlogin,a.Datemodified,a.Datecreated,b.Tenantname,b.Tenantkey,
			b.Tenantkrapin,b.Emailaddress AS Tenantemailaddress,b.Connectionstring,b.Tenantsubdomain,b.Tenantemailkey,b.Tenantemailpassword,
			(
