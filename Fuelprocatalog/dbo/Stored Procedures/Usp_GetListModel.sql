...
SET NOCOUNT ON;
If(@Type = 1)
Select r.Rolename as Text, r.RoleId as Value From Tenantroles r WHERE r.Isdefault =0 ;
If(@Type = 2)
...
If(@Type =9)
Select r.Permissionname as Text, r.PermissionId as Value From Tenantpermissions r;
If(@Type =10)
