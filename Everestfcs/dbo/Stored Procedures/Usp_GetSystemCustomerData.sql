...
BEGIN
   BEGIN
	DECLARE 
	    ...
	    a.ConsecutiveTransTimeMin,a.IsPortaluser,a.IsActive,a.IsDeleted,a.Extra,a.Extra1,a.Extra2,a.Extra3,a.Extra4,a.Extra5,a.Extra6,a.Extra7,a.Extra8,a.Extra9,a.Createdby,a.Modifiedby,b.Sname AS CustomerRegStation,c.Countryname AS CountryName,d.Firstname+' '+d.Lastname AS CustomerCreatedBy,e.Firstname+' '+e.Lastname  AS CustomerModofiedBy,a.Datecreated,a.Datemodified
		FROM Customers a
