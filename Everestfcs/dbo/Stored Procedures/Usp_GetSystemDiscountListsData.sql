...
BEGIN
   BEGIN
	DECLARE 
		...
		SELECT(
			SELECT a.DiscountListId,a.DiscountListname,a.IsDefault,a.IsActive,a.IsDeleted,b.Firstname+' '+ b.Lastname AS Createdby,c.Firstname+' '+ c.Lastname AS  Modifiedby,a.Datecreated,a.Datemodified,
			(
				...
				LEFT JOIN SystemStations bb ON aa.StationId=bb.StationId
