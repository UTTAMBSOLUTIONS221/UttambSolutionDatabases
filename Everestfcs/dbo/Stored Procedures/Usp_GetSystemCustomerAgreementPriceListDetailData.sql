   ...
   BEGIN
	DECLARE 
		...
		SET @PriceListDetails =(
			SELECT a.PriceListId,a.PriceListname,a.IsDefault,a.IsActive,a.IsDeleted,b.Firstname+' '+b.Lastname AS Createdby, c.Firstname+' '+c.Lastname AS Modifiedby,a.Datecreated,a.Datemodified,
			(
