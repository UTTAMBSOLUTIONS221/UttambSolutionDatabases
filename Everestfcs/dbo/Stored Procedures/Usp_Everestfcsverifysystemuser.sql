CREATE PROCEDURE [dbo].[Usp_Everestfcsverifysystemuser]
			...
			BEGIN 
					SET @StaffDetails = (
						SELECT
							...
							(
								SELECT a.Userid,a.Tenantid,b.Tenantname,b.Tenantsubdomain,e.Currencyname,e.Utcname,b.TenantLogo,a.Firstname , a.Firstname + ' ' + a.Lastname AS Fullname,d.Codename + '' + a.Phonenumber AS Phonenumber,
								...
								INNER JOIN SystemCountry e On b.CountryId=e.CountryId
