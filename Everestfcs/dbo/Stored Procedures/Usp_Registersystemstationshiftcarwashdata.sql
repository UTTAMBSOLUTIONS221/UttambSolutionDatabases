CREATE PROCEDURE [dbo].[Usp_Registersystemstationshiftcarwashdata]
   ...
   BEGIN
	...
	BEGIN
		...
		BEGIN TRANSACTION;
			...
			VALUES (source.ShiftId,source.StockTypeId,source.AttendantId,source.ProductVariationId,source.OpeningUnits,source.ClosingUnits,source.UnitsSold,source.ProductPrice,source.UnitsTotal,source.Createdby,source.Modifiedby,source.DateModified,source.DateCreated);
        Set @RespMsg ='Success'
		Set @RespStat =0; 
		COMMIT TRANSACTION;
