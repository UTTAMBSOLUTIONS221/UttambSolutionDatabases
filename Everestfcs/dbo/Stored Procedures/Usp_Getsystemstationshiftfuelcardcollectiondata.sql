CREATE PROCEDURE [dbo].[Usp_Getsystemstationshiftfuelcardcollectiondata]
@ShiftId BIGINT,
@start INT,
@length INT,
...
SET @DataTableData=(
		...
		SPV.ProductvariationId,SPV.ProductVariationName,SVV.ProductPrice,SVV.ProductQuantity,SVV.ProductDiscount,SVV.VoucherAmount,SVV.VatAmount,SVV.Extra,SVV.Extra1,SVV.Extra2,SVV.Extra3,SVV.Extra4,SVV.Extra5,SVV.Extra6,SVV.Extra7,SVV.Extra8,SVV.Extra9,SVV.Extra10,SVV.Createdby,SVV.Modifiedby,SVV.Datemodified,SVV.Datecreated
		...
		WHERE SVV.VoucherType='ShiftFuelCardCollection' AND SVV.ShiftId=SCC.ShiftId 
		ORDER BY SVV.ShiftVoucherId DESC 
		OFFSET @start ROWS FETCH NEXT @length ROWS ONLY
		FOR JSON PATH
		) AS DataTableData
		FROM ShiftVouchers SCC  
		WHERE SCC.VoucherType='ShiftFuelCardCollection' AND SCC.ShiftId=@ShiftId 
