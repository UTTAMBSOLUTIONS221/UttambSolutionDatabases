CREATE PROCEDURE [dbo].[Usp_Getsystemstationshiftdrystockpurchasedata]
@ShiftId BIGINT,
@start INT,
@length INT,
@searchParam VARCHAR(100),
@ShiftDryStockPurchases NVARCHAR(MAX) OUTPUT
AS
BEGIN
SET @ShiftDryStockPurchases=(
		...
		WHERE SDT.WetDryPurchase = 'DryStockPurchase' AND SDT.ShiftId = @ShiftId
