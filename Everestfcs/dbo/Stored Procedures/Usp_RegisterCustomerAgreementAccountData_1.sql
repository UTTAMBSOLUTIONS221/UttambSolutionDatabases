...
BEGIN
   BEGIN
	DECLARE @RespStat int = 0,
		...
		Set @RespStat =0; 
		COMMIT TRANSACTION;
		SELECT @RespStat as RespStatus, @RespMsg as RespMessage,CASE WHEN AA.Designation='Corporate' THEN AA.Companyname ELSE AA.Firstname+' '+ AA.Lastname END AS Data1,AA.Emailaddress AS Data2,EE.CardSNO AS Data3,EE.PIN AS Data4,EE.PinHarsh AS Data5,EE.CardCode AS Data6,EE.TenantId AS Data7 FROM Customers AA 
