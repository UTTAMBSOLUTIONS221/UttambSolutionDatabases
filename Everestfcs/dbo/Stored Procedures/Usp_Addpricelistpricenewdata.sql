...
BEGIN
    ...
    BEGIN TRY
		...
		DECLARE @ProductVat DECIMAL(18, 2) = ISNULL((SELECT JSON_VALUE(@JsonObjectdata, '$.ProductVat')), 0);
        ...
        -- Insert new row
            INSERT INTO PriceListprices (PriceListId, StationId, ProductvariationId, ProductPrice,ProductVat) 
            SELECT @PriceListId, StationId, @ProductvariationId, @ProductPrice, @ProductVat
