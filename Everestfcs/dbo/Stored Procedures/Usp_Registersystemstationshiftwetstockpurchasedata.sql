CREATE PROCEDURE [dbo].[Usp_Registersystemstationshiftwetstockpurchasedata]
...
BEGIN
   BEGIN
	...
	BEGIN
		...
		BEGIN TRANSACTION;
		BEGIN
			DECLARE @WetstockPurchase TABLE (PurchaseId BIGINT)
            ...
            OUTPUT inserted.PurchaseId INTO @WetstockPurchase;
			SET @WetstockPurchaseId = (SELECT PurchaseId FROM @WetstockPurchase);
