   ...
   BEGIN
	DECLARE 
        ...
        (
		  ...
		  (SELECT  STRING_AGG(bbb.Sname,',') FROM LSRuleStations aaa INNER JOIN SystemStations bbb ON aaa.StationId=bbb.StationId WHERE aaa.LSchemeRuleId = aa.LSchemeRuleId)AS Station,
