CREATE TABLE [dbo].[ShiftLubeandLpg] (
    [ShiftLubeLpgId]     BIGINT          IDENTITY (1, 1) NOT NULL,
    [ShiftId]            BIGINT          NOT NULL,
    [StockTypeId]        BIGINT          NOT NULL,
    [AttendantId]        BIGINT          NOT NULL,
    [ProductVariationId] BIGINT          NOT NULL,
    [OpeningUnits]       DECIMAL (18, 2) NOT NULL,
    [ClosingUnits]       DECIMAL (18, 2) NOT NULL,
    [UnitsSold]          DECIMAL (18, 2) NOT NULL,
    [ProductPrice]       DECIMAL (18, 2) NOT NULL,
    [UnitsTotal]         DECIMAL (18, 2) NOT NULL,
    ...
    PRIMARY KEY CLUSTERED ([ShiftLubeLpgId] ASC)
);
