CREATE  PROCEDURE [dbo].[Usp_Getsystemfortysevennewsblogdetaildatabyid]
@BlogId BIGINT,
...
BEGIN
   BEGIN
	DECLARE 
		...
		BEGIN TRANSACTION;
			SET @Fortysevennewsblogdata =(SELECT a.Systemblogid,a.Systemblogtitle,a.Systemblogdescription,a.Systemblogcategoryid,b.BlogCategoryName,a.Extra,a.Extra1,a.Extra2,a.Extra3,a.Extra4,a.Extra5,a.Extra6,a.Extra7,a.Extra8,a.Extra9,a.Createdby,c.Firstname+' '+ c.lastName as Createdbyname,a.Modifiedby,d.Firstname+' '+ d.lastName as Modifiedbyname,a.Datemodified,a.Datecreated,a.Systemblogstatus,a.Isactive,a.Isdeleted,
			( 
			...
			INNER JOIN Systemstaffs d ON a.Modifiedby=d.Staffid WHERE a.Systemblogid=@BlogId
