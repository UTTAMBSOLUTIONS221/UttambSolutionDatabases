CREATE PROCEDURE [dbo].[Usp_Getallproductvariationdata]
  @AllProductVariations NVARCHAR(MAX) OUTPUT
AS
BEGIN
   BEGIN
	DECLARE 
		...
		SELECT  @RespStat as RespStatus, @RespMsg as RespMessage,@AllProductVariations AS AllProductVariations;
