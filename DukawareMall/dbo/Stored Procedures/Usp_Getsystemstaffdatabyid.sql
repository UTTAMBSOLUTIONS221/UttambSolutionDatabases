...
BEGIN
   BEGIN
	DECLARE 
		...
		BEGIN TRANSACTION;
			 SELECT a.StaffId,ISNULL(b.Displayname,a.Firstname+' '+a.Lastname) AS Displayname,a.Username,C.RoleName,a.Firstname+''+a.Lastname AS Staffname,a.Emailaddress,a.Roleid,a.Phoneid,d.codename+''+ a.Phonenumber AS Phonenumber,a.Dob,a.Gender,
		  ...
		  INNER JOIN Systemphonecodes d ON a.Phoneid=d.PhoneId WHERE a.StaffId=@StaffId
	    Set @RespMsg ='Ok.'
		Set @RespStat =0; 
		COMMIT TRANSACTION;
