CREATE TABLE [dbo].[Customers] (
    ...
    FOREIGN KEY ([CountryId]) REFERENCES [dbo].[SystemCountry] ([CountryId]),
    CONSTRAINT [FK__Customers__Stati__6D2D2E85] FOREIGN KEY ([StationId]) REFERENCES [dbo].[SystemStations] ([Tenantstationid]),
    CONSTRAINT [FK__Customers__Stati__6E2152BE] FOREIGN KEY ([StationId]) REFERENCES [dbo].[SystemStations] ([Tenantstationid]),
    CONSTRAINT [FK__Customers__Stati__6F1576F7] FOREIGN KEY ([StationId]) REFERENCES [dbo].[SystemStations] ([Tenantstationid]),
