...
BEGIN
   BEGIN
	...
	BEGIN
		...
		End
		BEGIN TRANSACTION;
		INSERT INTO LFormulas(FormulaName,ValueType,CreatedBy,ModifiedBy,DateCreated,DateModified)
	    (SELECT JSON_VALUE(@JsonObjectdata, '$.FormulaName'),JSON_VALUE(@JsonObjectdata, '$.ValueType'),
