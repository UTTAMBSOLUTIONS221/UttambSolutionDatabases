...
--EXEC Usp_GetSystemCustomerAgreementtopuptransferData @Agreementaccountid=28
   ...
   BEGIN
	DECLARE 
		...
		BEGIN TRANSACTION;
		  ...
		  aa.Chequeno,aa.Bankaccno,aa.Drawerbank,aa.Payeebank,aa.Branchdeposited,ee.Isreversed,aa.Depositslip,aa.Createdby,dd.Fullname,aa.DateCreated
