 ...
 SELECT
        ...
        SELECT 
		    ...
		    (
				...
				INNER JOIN SystemStations S ON S.Tenantstationid = LDI.Stationid
				INNER JOIN SystemStaffs AS STF ON STF.StaffId = LDI.StaffId
				WHERE (
				...
				GROUP BY Ca.AccountId,(LDI.LRConversionDataInputId),C.IDNumber,STF.Fullname
