    ...
    END
        ...
        SELECT 
           ...
           (
			...
			E.Paymentmode as TopupMode,  A.CreatedBy as Attendant, A.Amount     
			...
			where A.TransactionDate >= TRY_CAST(JSON_VALUE(@JsonObjectdata, '$.Startdate') AS datetime2(6)) and A.TransactionDate <= dateadd(day,1,TRY_CAST(JSON_VALUE(@JsonObjectdata, '$.Enddate') AS datetime2(6))) 
